...
p01 = newp; Point(p01) = {dx2,dy2,0,mesh2};
p11 = newp; Point(p11) = {d3+dx2,dy2,0,mesh2};
p21 = newp; Point(p21) = {dx2,d3+dy2,0,mesh2};
p31 = newp; Point(p31) = {-d3+dx2,dy2,0,mesh2};
p41 = newp; Point(p41) = {dx2,-d3+dy2,0,mesh2};
