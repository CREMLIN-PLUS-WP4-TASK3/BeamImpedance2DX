...
p12 = newp; Point(p12) = {r3+dx2,dy2,0,mesh3};
p22 = newp; Point(p22) = {dx2,r3+dy2,0,mesh3};
p32 = newp; Point(p32) = {-r3+dx2,dy2,0,mesh3};
p42 = newp; Point(p42) = {dx2,-r3+dy2,0,mesh3};
...
Physical Surface("beam") = {s1};
Physical Surface("vacuum") = {s12};
Physical Surface("steel") = {s10};
