...
from .material import Material, FileInterpolate
...
_mu8c11_re_interpolate = FileInterpolate(_mu8c11_file, 0, 1)
_mu8c11_im_interpolate = FileInterpolate(_mu8c11_file, 0, 2)
