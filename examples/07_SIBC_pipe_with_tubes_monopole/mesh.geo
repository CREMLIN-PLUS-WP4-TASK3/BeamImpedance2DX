...
p01 = newp; Point(p01) = {dx3,dy3,0,mesh2};
p11 = newp; Point(p11) = {d3+dx3,dy3,0,mesh2};
p21 = newp; Point(p21) = {dx3,d3+dy3,0,mesh2};
p31 = newp; Point(p31) = {-d3+dx3,dy3,0,mesh2};
p41 = newp; Point(p41) = {dx3,-d3+dy3,0,mesh2};
...
p02 = newp; Point(p02) = {dx4,dy4,0,mesh2};
p12 = newp; Point(p12) = {d3+dx4,dy4,0,mesh2};
p22 = newp; Point(p22) = {dx4,d3+dy4,0,mesh2};
p32 = newp; Point(p32) = {-d3+dx4,dy4,0,mesh2};
p42 = newp; Point(p42) = {dx4,-d3+dy4,0,mesh2};
...
s10 = news; Surface(s10) = {ll10,ll1,ll11,ll12};

Transfinite Curve{l1,l2,l3,l4} = 20;
Transfinite Curve{l10,l20,l30,l40} = 100;

Physical Surface(1) = {s1}; // beam
Physical Surface(2) = {s10}; // vacuum
Physical Line(3) = {l10,l20,l30,l40}; // external boundary
Physical Line(4) = {l11,l21,l31,l41}; // right hole
Physical Line(5) = {l12,l22,l32,l42}; // left hole
