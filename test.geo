...
p1 = newp; Point(p1) = {r1+dx1,dy1,0};
p2 = newp; Point(p2) = {dx1,r1+dy1,0};
p3 = newp; Point(p3) = {-r1+dx1,dy1,0};
p4 = newp; Point(p4) = {dx1,-r1+dy1,0};
...
p00 = newp; Point(p00) = {dx2,dy2,0};
p10 = newp; Point(p10) = {r2+dx2,dy2,0};
p20 = newp; Point(p20) = {dx2,r2+dy2,0};
p30 = newp; Point(p30) = {-r2+dx2,dy2,0};
p40 = newp; Point(p40) = {dx2,-r2+dy2,0};
